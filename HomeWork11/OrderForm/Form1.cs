    ...
    public partial class Form1 : Form
    {
        ...
        private void queryDetail_Click(object sender, EventArgs e)
        {
            ...
            if(selectOrder>=0)
            {
                ...
                OrderDetails.DataSource = orderService.checkByOrderNum(number).FirstOrDefault().orderDetails;
                this.orderDetailDataGridView.DataSource = OrderDetails;
            }
        ...
        private void ImportBtn_Click(object sender, EventArgs e)
        {
            ...
            queryOrder = orderService.Import(filename);//调用orderservice的导入函数

            //重置显示界面
            Orders.DataSource = queryOrder;
        }

        //点击“导出订单”按钮时实现的功能(导出所有订单)
