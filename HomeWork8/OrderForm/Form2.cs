    ...
    public partial class Form2 : Form
    {
        ...
        public Form2(OrderService orderService, int flag)
        {
            ...
            if(flag != -1)
            {
                ...
                isAdd = false;
                //存取要修改的订单
                this.changeOrder = orderService.orders.Find(obj => obj.orderNum == flag);
            }
            else
            {
                this.Text = "添加订单";
        ...
        private void Form2_Load(object sender, EventArgs e)
        {
            ...
            {
                //修改订单时，填入订单原信息
                this.Nametxt.Text = changeOrder.Customer_name;
        ...
        private void DeleteDetailBtn_Click(object sender, EventArgs e)
        {
            ...
            if (selectOrderDetail >= 0)
            {
                ...
                this.changeOrder.orderDetails.RemoveAll(obj => obj.name == name && obj.store == store
                                                        && obj.itemNum == num && obj.price == price);
            }
        }
        ...
        private void SaveOrderBtn_Click(object sender, EventArgs e)
        {
            ...
            {
                changeOrder.customer.name = this.Nametxt.Text;
            }
            ...
            //添加失败弹出错误窗口
            if (isAdd && !OrderService.addOrder(changeOrder))
            {
