...
namespace Crawler
{
    ...
    public partial class Form1 : Form
    {
        ...
        private void Crawler_PageDownloaded(Crawler crawler, string url, string info, string Time)
        {
            lock (urlSource)
            {
                var pageInfo = new { Index = urlSource.Count + 1, URL = url, Status = info, Time = DateTime.Now.ToString() };
